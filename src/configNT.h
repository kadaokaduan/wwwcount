...
**  Note: do not get confused with /. it's OK. \ was a DOS's command.com
**  limitation.
*/
#define CONFIG_DIR  "wcount/conf"
#define CONFIG_FILE "count.cfg"
#define DATA_DIR    "wcount/data"
#define DIGIT_DIR   "wcount/digits"
#define LOG_DIR     "wcount/logs"
...
*/
#define RGB_MAPPING_DICT            "wcount/rgb.txt"
/*
